  ...
  val tests: Tests = Tests {
    ...
    test("type parameter with bounds of another type parameter") {
      success(
        ...
        """interface TypeParameterWithParamBounds<A, B extends A>""".stripMargin
      )
    }
    ...
    test("higher-kinded type parameter bounds") {
      success(
        "HigherKindedTypeParameterBounds#",
        """interface HigherKindedTypeParameterBounds<A, B extends A>""".stripMargin
      )
    }
  }
}
